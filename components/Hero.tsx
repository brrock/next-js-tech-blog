...
import TypewriterEffect from "./typewriteranimation";

export default function Hero() {
	const text = "Full-Stack Developer & Linux Enthusiast";

	return (
		<section className="min-h-screen flex items-center justify-center pt-20 bg-gradient-to-br from-purple-800 via-pink-700 to-orange-600 dark:from-purple-900 dark:via-pink-800 dark:to-orange-700 font-sans">
			<motion.div
